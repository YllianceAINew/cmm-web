                        ...
                        <div class="div-view table-responsive">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if($hist['logLevel'] == 0){
                                       $chkColor = "#FFFF99";
                                        echo "<tr class='odd gradeX' style = 'background-color:#FFFF99'>";
                                    }
                                    if($hist['logLevel'] == 1){
                                        $chkColor = "#FFCC99";
                                        echo "<tr class='odd gradeX' style = 'background-color:#FFCC99'>";
                                    }
                                    if($hist['logLevel'] == 2){
                                        $chkColor = "#FF9900";
                                        echo "<tr class='odd gradeX' style = 'background-color:#FF9900'>";
                                    }
                                ?>
                                    ...
                                    <td>{{ i }}</td>
                                    <td class="loglevel">{{level[hist['logLevel']]}}</td>
                                    <td class="logcontent">{{hist['logContent']}}</td>
                                    <td class="logdate">{{hist['logDate']}}</td>
                                    <td> <a class="deleteHistBtn"><img src="{{url('')}}pages/img/delete.gif" data-toggle="modal" href = "#deleteHist"></a> </td>
                                </tr>
                                {% endfor %}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" id="okBtn" onClick="onDeleteHistory()">{{ lang._('btn_ok') }}</button>
