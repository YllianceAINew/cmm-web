        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    {{ lang._('menu_servermanager_sipserver_sub') }}
                </h3>
                <div class="card-tools">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="sipservers">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr class="server_col">
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-danger deleteSip" serverIp="{{server['ip']}}">
...
<!-- Edit HAProxy/Kamailio Server Modal -->
